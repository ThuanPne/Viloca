# Spec: register-validation

## Purpose

Defines the client-side validation and UX behaviour for the registration screen, covering email format checks, password strength enforcement, real-time feedback UI, and inline error presentation.
